...
# daca o anumita variabila respecta o conditie atunci printam ceva, daca nu printam altceva.
...
# Ex: 10 Avand stringul '0123456789' afiseaza doar numerele pare si apoi doar numerele impare (hint: foloseste slicing si controleaza afisarea in slicing cu slicing step)
word = '0123456789'
print(word[0::2])
print(word[1::2])
